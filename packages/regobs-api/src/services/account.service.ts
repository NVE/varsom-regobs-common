...
class AccountService extends __BaseService {
   ...
   * @return OK
   */
  AccountGetMyPageDataResponse(langKey?: 1 | 2 | 3 | 4 | 5 | 6 | 7): __Observable<__StrictHttpResponse<MyPageData>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return OK
   */
  AccountGetMyPageData(langKey?: 1 | 2 | 3 | 4 | 5 | 6 | 7): __Observable<MyPageData> {
